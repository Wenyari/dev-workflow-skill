 ...
 * `node "{figma-sync-skill-dir}/scripts/figma-sync-report.mjs" --reset` 清空。
 *
 * 路径：系统临时目录下按消费仓库绝对路径隔离，不写入 Git 工作区。
 *
 * 去重契约：
...
import { resolveSessionLogPath } from './runtime-paths.mjs'

const LOG_PATH = resolveSessionLogPath()
